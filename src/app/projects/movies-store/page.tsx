...
export default function MoviesStoreCaseStudy() {
  return (
    <main className="case-study">
      <header className="site-header case-header"><Link className="wordmark" href="/">AS<span>.</span></Link><Link className="back-link" href="/#projects">&lt;- Back to portfolio</Link><span className="header-availability"><span className="status-dot" /> More information / 01</span></header>
      ...
      <section className="case-close section-shell"><Link className="button button-primary" href="/#projects">Return to portfolio <span aria-hidden="true">-&gt;</span></Link></section>
    </main>
  );
}
