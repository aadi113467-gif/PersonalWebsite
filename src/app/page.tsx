        ...
        <div className="about-content" data-reveal>
          ...
          <div className="coursework-block">
            ...
            <div className="course-route">
              ...
              <div className="course-stop stop-green"><span className="course-dot" /><span>Machine Learning</span></div>
              <div className="course-stop stop-red"><span className="course-dot" /><span>Artificial Intelligence</span></div>
              <div className="course-stop stop-gold"><span className="course-dot" /><span>Software Engineering</span></div>
              <div className="course-stop stop-green"><span className="course-dot" /><span>Linear Algebra</span></div>
              <div className="course-stop stop-red"><span className="course-dot" /><span>Multivariable Calculus</span></div>
              <div className="course-stop stop-gold"><span className="course-dot" /><span>Discrete Math</span></div>
              <div className="course-stop stop-green"><span className="course-dot" /><span>Probability &amp; Statistics</span></div>
            </div>
          </div>
